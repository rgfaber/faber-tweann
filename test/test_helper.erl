...
register_all_example_morphologies() ->
    ...
    ok = morphology_registry:register(pb_1_with_velocity, morphology_pole_balancing),
    ok = morphology_registry:register(pb_1_without_velocity, morphology_pole_balancing),
    ok = morphology_registry:register(pb_2_with_velocity, morphology_pole_balancing),
    ok = morphology_registry:register(pb_2_without_velocity, morphology_pole_balancing),
    ok = morphology_registry:register(tmaze, morphology_tmaze),
...
unregister_all_example_morphologies() ->
    ...
    ok = morphology_registry:unregister(pb_1_with_velocity),
    ok = morphology_registry:unregister(pb_1_without_velocity),
    ok = morphology_registry:unregister(pb_2_with_velocity),
    ok = morphology_registry:unregister(pb_2_without_velocity),
    ok = morphology_registry:unregister(tmaze),
